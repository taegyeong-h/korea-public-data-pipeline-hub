...
<img width="1833" height="1395" alt="image" src="https://github.com/user-attachments/assets/fef5a0eb-e1ed-4660-8e7e-e4a3fcacb0fb" />


## 2. 데이터 형식 (Sample)
원본 파일의 1~3행(불필요한 헤더 및 빈 행)을 제거하고, 순수 헤더를 4행에서 1행으로 올린 데이터 구조입니다.
<img width="1322" height="1538" alt="image" src="https://github.com/user-attachments/assets/c20ab0dd-b30a-4dbc-902a-810f5202f9d7" />
